...
def format_free_preview(report: PartnerReport) -> str:
    ...
    return f"""
💞 Инструкция к вашему мужчине: первый ключ
...
Как применять без магии и угадайки:
1. Дайте ему подходящий ритм Луны.
2. Смотрите на реакцию: стало спокойнее, теплее или яснее?
3. Только потом переходите к серьёзному разговору.
