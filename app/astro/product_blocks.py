...
COUPLE_DIAGNOSTICS = {
    ("fire", "fire"): (
        "Вы быстро оживляете друг друга. В такой паре много энергии, реакции, желания действовать и не застревать в тяжёлых паузах.",
        "Контакт может перегреваться: оба могут ждать мгновенного отклика, резко реагировать и путать живость с борьбой за внимание.",
        "Сохранять искру, но вводить паузу перед резкими словами. Лучше договариваться о следующем шаге, чем выяснять, кто ярче горит.",
    ),
    ("fire", "earth"): (
        "Вы можете соединить движение и надёжность: один даёт импульс, другой помогает контакту не рассыпаться и стать реальным.",
        "Один может хотеть быстрого отклика, а другой раскрываться медленнее. Из-за этого живость может казаться давлением, а спокойствие — холодом.",
        "Делать шаги живо, но не резко. Давать инициативу, но оставлять человеку время почувствовать устойчивость.",
    ),
    ("fire", "air"): (
        "У вас может быть лёгкий, живой, интересный контакт: идеи быстро превращаются в движение, а разговор не даёт связи застаиваться.",
        "Можно много загораться, обсуждать и обещать, но терять глубину или конкретный следующий шаг.",
        "После живого разговора фиксировать простое действие: встречу, звонок, прогулку, маленькую договорённость.",
    ),
    ("fire", "water"): (
        "Вы можете соединить искру и нежность: один оживляет контакт, другой делает его глубже и эмоциональнее.",
        "Быстрый импульс может пугать более чувствительный ритм, а мягкость может восприниматься как неопределённость или отстранение.",
        "Добавлять тепло к инициативе. Не торопить чувство, но и не оставлять контакт в тумане.",
    ),
    ("earth", "fire"): (
        "Вы можете соединить опору и движение: один создаёт стабильность, другой возвращает в контакт жизнь и интерес.",
        "Один может хотеть спокойного темпа, а другой ждать быстрой реакции. Тогда надёжность кажется скукой, а живость — лишней суетой.",
        "Сначала дать ощущение безопасности, потом добавлять движение. Не ломать ритм резкостью, но и не давать связи заснуть.",
    ),
    ("earth", "earth"): (
        "Ваша сильная сторона — надёжность. Тепло здесь растёт через поступки, повторяемость, заботу и ощущение, что рядом можно расслабиться.",
        "Главный риск — привыкнуть к стабильности и перестать оживлять контакт. Тогда тепло может стать фоном, который уже не замечают.",
        "Сохранять понятность, но добавлять маленькие живые жесты: прогулки, прикосновения, совместные планы, простые приятные ритуалы.",
    ),
    ("earth", "air"): (
        "Вы можете соединить конкретику и ясность: один помогает сделать контакт надёжным, другой — проговорить то, что иначе осталось бы в молчании.",
        "Один может ждать дел и устойчивости, другой — разговора и пространства. Тогда слова кажутся пустыми, а молчание — закрытостью.",
        "Переводить слова в маленькие действия, а действия — в понятные слова. Не требовать, чтобы другой угадывал без объяснения.",
    ),
    ("earth", "water"): (
        "Это мягкая и тёплая связка: один даёт опору, другой добавляет чувство. Вместе можно создавать ощущение дома и эмоциональной безопасности.",
        "Если действия остаются без слов, чувствительному ритму может не хватать тепла. Если чувства становятся слишком зыбкими, земному ритму может не хватать ясности.",
        "Соединять заботу делом и заботу словом. Не выбирать между стабильностью и нежностью, а давать им работать вместе.",
    ),
    ("air", "fire"): (
        "У вас может быть много живого обмена: разговоры быстро оживляют контакт, а импульс помогает не оставаться только в мыслях.",
        "Можно спорить ради энергии, уходить в резкие слова или быстро перескакивать с темы на тему, не доходя до настоящей близости.",
        "Сохранять лёгкость, но не превращать контакт в соревнование реакций. После разговора выбирать один понятный шаг.",
    ),
    ("air", "earth"): (
        "Вы можете соединить ясность и устойчивость: один помогает говорить, другой — делать связь надёжной и спокойной.",
        "Один может искать объяснения и свободу, другой — конкретику и предсказуемость. Из-за этого разговор может казаться уходом от дела, а устойчивость — давлением.",
        "Давать словам форму: договорённости, планы, простые подтверждения. И давать делам голос: объяснять, что за ними стоит.",
    ),
    ("air", "air"): (
        "Ваша сильная сторона — лёгкость понимания. Вы можете сближаться через разговор, юмор, мысли, переписку и ощущение внутреннего пространства.",
        "Главный риск — остаться в словах и не дать контакту глубины, тела, устойчивости или эмоционального подтверждения.",
        "Оставлять воздух, но добавлять присутствие: не только говорить о близости, но и показывать её действиями, временем и вниманием.",
    ),
    ("air", "water"): (
        "Вы можете соединить ясность и чувство: один помогает назвать происходящее, другой — вернуть словам тепло и эмоциональную глубину.",
        "Ясность может звучать слишком холодно, а чувство — слишком размыто. Тогда один просит объяснить, другой хочет, чтобы его просто почувствовали.",
        "Говорить мягче и чувствовать яснее. Лучше прямо называть важное, но тоном, в котором есть бережность.",
    ),
    ("water", "fire"): (
        "Вы можете соединить глубину и искру: один даёт эмоциональную включённость, другой помогает контакту оживать и двигаться.",
        "Чувствительность может закрываться от резкости, а живой импульс может раздражаться от долгой неопределённости.",
        "Давать инициативу через тепло, а чувства — через ясные сигналы. Не давить скоростью и не исчезать в настроении.",
    ),
    ("water", "earth"): (
        "Вы можете создать очень тёплую опору: чувство получает форму, а стабильность становится не сухой, а живой и заботливой.",
        "Если земной ритм молчит и просто делает, водный может не чувствовать тепла. Если водный ритм уходит в переживания, земной может терять понятность.",
        "Подтверждать любовь и делом, и тоном. Простая забота плюс мягкие слова здесь работают сильнее громких драм.",
    ),
    ("water", "air"): (
        "Вы можете соединить чувство и понимание: один тонко улавливает атмосферу, другой помогает не тонуть в догадках и проговаривать важное.",
        "Один может ждать эмоционального считывания, другой — ясных слов. Тогда молчание становится тревогой, а объяснения кажутся недостаточно тёплыми.",
        "Не заставлять угадывать. Говорить прямо, но бережно: что чувствуется, что важно, какой маленький шаг поможет сейчас.",
    ),
    ("water", "water"): (
        "Ваша сильная сторона — эмоциональная тонкость. Вы можете чувствовать настроение друг друга без лишних объяснений и создавать глубокое тепло.",
        "Главный риск — утонуть в настроениях, обидах и недосказанности. Когда оба чувствительны, тишина может становиться слишком громкой.",
        "Давать чувствам спокойный берег: мягко проговаривать важное, не копить обиды и не проверять любовь молчанием.",
    ),
}
...
Сильная сторона вашей пары:
{strength}

Где вы можете терять контакт:
{loss}
