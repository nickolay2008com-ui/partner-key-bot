...
MODERN_ASTROLOGER_CONTEXT = (
    ...
    "и какой маленький шаг улучшает контакт через бережный шаг."
)
...
MARS_INTRO = (
    ...
    "Чтобы понять партнёра, Марс отвечает на вопрос: как он движется к желаемому, как берёт своё и как действует в напряжении?"
)
...
Коротко: задача не решить, кто чувствует «правильно», а перевести два ритма в понятный контакт — что даёт ему спокойствие, что даёт вам тепло и какой маленький шаг не создаёт напора.

Что сделать сейчас:
1. Дайте ему его формат безопасности.
2. Одной фразой назовите свой формат тепла.
3. Сравните реакцию: стало спокойнее, яснее или теплее?{precision_line}
...
Гармония здесь не в том, чтобы кто-то стал удобнее. Она в том, чтобы превратить «почему он/я так реагирую?» в понятный мост: что даёт ему спокойствие, что даёт вам тепло и какой маленький шаг можно сделать в бережном темпе.
""".strip()
