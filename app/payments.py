...
PRODUCTS: dict[str, Product] = {
    "details": Product(
        "details",
        "Глубокий ключ к партнёру",
        "Полный разбор: эмоции, симпатия, стиль общения и первый шаг.",
        15,
    ),
    "message": Product(
        "message",
        "Что написать партнёру",
        "Три мягких варианта сообщения под эмоциональный язык партнёра.",
        10,
    ),
}
